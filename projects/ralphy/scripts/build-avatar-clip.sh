...
# Example: ./build-avatar-clip.sh 01-hook hive:3015
#
# IMPORTANT: For parallel builds, use DIFFERENT hive servers to avoid GPU OOM:
#   Terminal 1: ./build-avatar-clip.sh 01-hook hive:3015
#   Terminal 2: ./build-avatar-clip.sh 99-cta hive:3016
...
if [ -z "$NAME" ]; then
    ...
    echo "Example: $0 01-hook hive:3015"
    echo ""
