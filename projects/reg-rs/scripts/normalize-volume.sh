...
#
# Default target: -25 dB (matches reference epilog with soaring.mp3)
# This script modifies the clip IN PLACE
#
# CRITICAL: Also enforces 44100 Hz stereo format to prevent
# audio loss during concatenation. This is a recurring bug
# that has wasted many hours. ALWAYS enforce format.
#
# Called by build scripts after each clip is created to ensure
# consistent audio levels AND FORMAT before concatenation.
